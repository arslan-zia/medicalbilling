								...
								<div id="kt_app_content_container" class="app-container container-xxl">
											...
											<div class="card h-lg-100">
												...
												<div class="card-body d-flex justify-content-between align-items-start flex-column">
													...
													<div class="d-flex flex-column my-7">
														<!--begin::Number-->
														<span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2"><?php echo $leadModel->getLeadCount(); ?></span>
														<!--end::Number-->
														<!--begin::Follower-->
														<div class="m-0">
										...
										<div class="col-sm-6 col-xl-3 mb-5 mb-xl-10">
											...
											<div class="card h-lg-100">
												...
												<div class="card-body d-flex justify-content-between align-items-start flex-column">
													...
													<div class="d-flex flex-column my-7">
														<!--begin::Number-->
														<span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2"><?php echo $loginModel->getTotalUsers(); ?></span>
														<!--end::Number-->
														<!--begin::Follower-->
														<div class="m-0">
									...
									<div class="row g-6 g-xl-9">
										...
										<div class="col-md-6 col-xl-6">
											<!--begin::Card-->
											<a href="<?php echo ADMIN_URL; ?>users.php" class="card border-hover-primary">
												<!--begin::Card header-->
										...
										<div class="col-md-6 col-xl-6">
											<!--begin::Card-->
											<a href="<?php echo ADMIN_URL; ?>leads.php" class="card border-hover-primary">
												<!--begin::Card header-->
												<div class="card-header border-0 pt-9">
													<!--begin::Card Title-->
													<div class="card-title m-0">
												...
												<div class="card-body p-9">
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
														...
														<!--begin::Table body-->
														<tbody class="fw-bold text-gray-600">
															<?php $allLeads = $leadModel->getAllLeads(0,0,0,5,"DESC");
