<?php include(dirname(dirname(__FILE__)) . '/class/class.php'); 
	...
	{
		if(isset($_POST['profile_settings']) && $_POST['profile_settings'] == 'true')
		{
			...
			$result = $loginModel->editSuperAdminProfile($adminID);

			if($result === true)
			{
				header("Location: " . ADMIN_URL . "profile_settings.php?action=success&message=Profile Updated Successfully");
				exit;
			}
			else
			{
				header("Location: " . ADMIN_URL . "profile_settings.php?action=fail&message=" . urlencode($result));
				exit;
			}
		}	
	}
...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="Profile Settings - <?php echo SITE_NAME; ?>" />
		<meta name="keywords" content="Profile Settings - <?php echo SITE_NAME; ?>" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Profile Settings - <?php echo SITE_NAME; ?>" />
		<meta property="og:url" content="<?php echo SERVER; ?>" />
		<meta property="og:site_name" content="<?php echo SITE_NAME; ?> | Profile Settings" />
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Profile Settings</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
											...
											<div class="card">
												...
												<div class="card-body p-12">
													...
													<form action="" method="post" id="kt_invoice_form" name="edit_user_form" class="form-horizontal" enctype="multipart/form-data">
														...
														<input type="hidden" name="profile_settings" value="true" />
														<!--begin::Separator-->
														...
														<div class="mb-0">
															...
															<div class="row gx-10 mb-5">
																...
																<div class="col-lg-6">
																	...
																	<div class="mb-5">
																		<input type="email" class="form-control form-control-solid" name="email" placeholder="Enter Email ID" value="<?php echo htmlspecialchars($userInfo['email']); ?>" />
																	</div>
																	<!--end::Input group-->
																</div>
																...
																<div class="col-lg-6">
																	<!--begin::Input group-->
																	<label class="form-label fs-6 fw-bold text-gray-700 mb-3">Official Address</label>
																	<div class="mb-5">
