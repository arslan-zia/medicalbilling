<?php include(dirname(dirname(__FILE__)) . '/class/class.php'); 
	...
	if(isset($_POST['action']) && $_POST['action'] == 'yes')
	{
		...
		{            
			...
			{
				header("Location: " . ADMIN_URL . "change_password.php?action=" . $result_type . "&message=" . urlencode($result_message));
				exit;
			}
			else
			{
													...
													<form action="" method="post" id="kt_invoice_form" name="edit_user_form" class="form-horizontal" enctype="multipart/form-data">
														...
														<div class="mb-0">
															...
															<div class="row gx-10 mb-5">
																...
																<div class="col-lg-9">
																	<!--begin::Input group-->
																	<label class="form-label fs-6 fw-bold text-gray-700 mb-3">Current Password</label>
																	<div class="mb-5">
