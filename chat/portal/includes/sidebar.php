...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
		...
		<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
			...
			<div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
				...
				<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
					...
					<!--begin:Menu item-->
					<div data-kt-menu-trigger="click" class="menu-item <?php if($pageName == 'add_lead.php' || $pageName == 'leads.php' || $pageName == 'view_lead.php'){ echo "here show";} ?> menu-accordion">
						<!--begin:Menu link-->
						<span class="menu-link">
							<span class="menu-icon">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link <?php if($pageName == 'leads.php'){ echo "active";} ?>" href="<?php echo PORTAL_URL; ?>leads.php">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link <?php if($pageName == 'add_lead.php'){ echo "active";} ?>" href="<?php echo PORTAL_URL; ?>add_lead.php">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
					...
					<?php if(isset($_SESSION['sess_user_type']) && $_SESSION['sess_user_type'] == 3)
					{
					?>
					<!--begin:Menu item-->
					<div data-kt-menu-trigger="click" class="menu-item <?php if($pageName == 'add_user.php' || $pageName == 'users.php' || $pageName == 'edit_user.php' || $pageName == 'view_user.php'){ echo "here show";} ?> menu-accordion">
						<!--begin:Menu link-->
						<span class="menu-link">
							<span class="menu-icon">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link <?php if($pageName == 'users.php'){ echo "active";} ?>" href="<?php echo PORTAL_URL; ?>users.php">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link <?php if($pageName == 'add_user.php'){ echo "active";} ?>" href="<?php echo PORTAL_URL; ?>add_user.php">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
					...
					<div data-kt-menu-trigger="click" class="menu-item <?php if($pageName == 'edit_profile.php' || $pageName == 'change_password.php' || $pageName == 'product_category.php'){ echo "here show";} ?> menu-accordion">
						<!--begin:Menu link-->
						<span class="menu-link">
							<span class="menu-icon">
						...
						<div class="menu-sub menu-sub-accordion" kt-hidden-height="84" style="">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link <?php if($pageName == 'edit_profile.php'){ echo "active";} ?>" href="<?php echo PORTAL_URL; ?>edit_profile.php">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link <?php if($pageName == 'change_password.php'){ echo "active";} ?>" href="<?php echo PORTAL_URL; ?>change_password.php">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link <?php if($pageName == 'ip-settings.php'){ echo "active";} ?>" href="<?php echo PORTAL_URL; ?>ip-settings.php">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
	...
	<div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
		<a href="login.php?action=logoutUser" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
