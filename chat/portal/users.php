										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
													<!--begin::Add customer-->
													<a href="<?php echo PORTAL_URL; ?>add_user.php" class="btn btn-sm btn-primary">Add User</a>
													<!--end::Add customer-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
										...
										<div class="card-body pt-0">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<tbody class="fw-semibold text-gray-600">
													<?php												
													$allUsers	=	$loginModel->allUsers(0, $userID);
...
?>															<tr>
																...
																<td class="text-end">
																	...
																	<a href="<?php echo PORTAL_URL; ?>view_user.php?user_id=<?php echo $user['user_id']; ?>" class="fw-bold" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" title="View User">
																		<i class="bi bi-eye fs-6 text-muted me-1"></i>
																	</a>
																	&nbsp;
																	<a href="<?php echo PORTAL_URL; ?>edit_user.php?user_id=<?php echo $user['user_id']; ?>" class="fw-bold" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" title="Edit User">
