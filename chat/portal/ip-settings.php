										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
													...
													?>
													<button type="button" class="btn btn-sm <?php echo $class; ?> me-3" id="ip_restriction_toggle" data-ip-restrictions-status="<?php echo $ipRestrictionsStatus; ?>">
														<i class="ki-duotone ki-shield-tick fs-2">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
														IP Restrictions Status: <span id="restriction_status"><b><?php echo $ipRestrictionsStatus; ?></b></span>
													</button>
...
?>															<tr>
																...
																<td class="text-end">
																	...
																	<?php if($ipSetting['added_by'] == $_SESSION['sess_user_id'])
																	{
																	?>
