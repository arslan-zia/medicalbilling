										...
										<div class="card-body pt-0">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														*/ ?>
														...
														<th class="min-w-125px">Dispute Date</th>
														<th class="min-w-125px">Dispute Amount</th>
												...
												<tbody class="fw-semibold text-gray-600">
													...
													{
														$leads = $leadModel->getAllLeads(0, $team_member_ids);
														
													} else
													{
														$leads = $leadModel->getAllLeads(0, $_SESSION['sess_user_id']);
													}
													...
													if( sizeof($leads) > 0 )
													{
														...
														<tr>
															...
															*/ ?>
															...
															<td><?php echo htmlspecialchars($lead['dispute_date']); ?></td>
															<td><?php echo htmlspecialchars($lead['dispute_amount']); ?></td>
															<td><?php echo $lead['status'] == 1 ? 'Active' : 'Inactive'; ?></td>
															<td class="text-end">

																<a href="<?php echo PORTAL_URL; ?>view_lead.php?lead_id=<?php echo $lead['lead_id']; ?>" class="fw-bold" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" title="View Lead">
