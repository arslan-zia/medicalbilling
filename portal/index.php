											...
											<div class="card h-lg-100">
												...
												<div class="card-body d-flex justify-content-between align-items-start flex-column">
													...
													<div class="d-flex flex-column my-7">
														...
														?>
														<span class="fw-semibold fs-2x text-gray-800 lh-1 ls-n2"><?php echo $leadModel->getLeadCount($user_id); ?></span>
														<!--end::Number-->
														<!--begin::Follower-->
														<div class="m-0">
										...
										<div class="col-sm-6 col-xl-3 mb-5 mb-xl-10">
											...
											<div class="card h-lg-100">
												...
												<div class="card-body d-flex justify-content-between align-items-start flex-column">
													...
													<div class="d-flex flex-column my-7">
														<!--begin::Number-->
														<span class="fw-semibold fs-2x text-gray-800 lh-1 ls-n2"><?php echo $loginModel->getTotalUsers($userID); ?></span>
														<!--end::Number-->
														<!--begin::Follower-->
														<div class="m-0">
