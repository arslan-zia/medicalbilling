...
<!--begin::Javascript-->
  ...
  <script>
    ...
    function toggleUserList() {
      ...
      document.getElementById('chatWindow').style.setProperty('display', 'none', 'important');
      document.getElementById('userListPopup').style.setProperty('display', 'block', 'important');
    ...
    function closeChat() {
      ...
      document.getElementById('chatWindow').style.setProperty('display', 'none', 'important');
      document.getElementById('userListPopup').style.setProperty('display', 'none', 'important');
    }
    ...
    function sendMessage(file = null) {
      ...
      formData.append('work', 'sendMessageV2');
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      onChildAdded(messagesQuery, (data) => {
        ...
        if (msg.is_chat_deleted) { 
          $('#chatMessages').html(`
            <div class="message-container text-center">
              <div class="chat-message delete">${msg.message}</div>
        ...
        $(`.chat-user[data-chat-id="${chatId}"]`).addClass('new-message');
      });
    });
